        ...
        <section class="content">
            ...
            <div class="container">
                ...
                <div class="col-lg-8 col-md-8">
                    ...
                    <main>                                       
                        <?php 
                              $esp = $_SESSION["especialista"]["id"];
                        $sql20 = "select idcategoria from usuario where id = $esp";
                        $consult = $pdo->prepare($sql20);
                        $consult->execute();
                        $dado = $consult->fetch(PDO::FETCH_OBJ);
                        $categoria = $dado->idcategoria;
                        //echo "$categoria";

                                            //$sql = "select * from pergunta order by data desc";
                        $sql = "select p.*, c.categoria, u.nome from pergunta p join categoria c on (c.id = p.idcategoria) join usuario u on (u.id = p.idUsuario) where p.idcategoria = $categoria";
                        $consulta = $pdo->prepare($sql);
                        $consulta->execute(); 
