...
if ( !isset( $_SESSION["usuario"]["id"] ) ) {
    ...
    header( "Location: ../admin/indexUsuario.php" );
}
       ...
       <div class="container">
        <div class="col-lg-8 col-md-8">
            ...
            <div class="sidebarblock">
                ...
                <div class="sidebarblock">
                    <?php 
                    $sql = "select u.*, r.idUsuario, count(r.resposta) from usuario u join resposta r on (r.idUsuario = u.id) where r.idUsuario = u.id group by u.nome order by r.idUsuario ASC";                    $consulta = $pdo->prepare($sql);
                    $consulta->execute();
                    while ( $dados = $consulta->fetch(PDO::FETCH_OBJ) ) {
                     $id = $dados->id;
                     $nome = $dados->nome;
